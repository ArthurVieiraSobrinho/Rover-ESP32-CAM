...
void setup() {
 ...
 server.on("/", HTTP_GET, [](AsyncWebServerRequest *request){
  request->send_P(200, "text/html", R"rawliteral(
    <html>
    <body>
    <h1>Rover Do Arthur</h1>
    <img id="stream" src="" width="800" height="600" style="transform: rotate(180deg);" />
    <br/>
    <button onmousedown="ComecarMovimento('Frente')" onmouseup="PararMovimento()" < !--esse codigo será comentado --> 
            ontouchstart="ComecarMovimento('Frente')" ontouchend="PararMovimento()">Frente</button>
    <button onmousedown="ComecarMovimento('Atras')" onmouseup="PararMovimento()" 
            ontouchstart="ComecarMovimento('Atras')" ontouchend="PararMovimento()">Tras</button>
    <button onmousedown="ComecarMovimento('Esquerda')" onmouseup="PararMovimento()" 
            ontouchstart="ComecarMovimento('Esquerda')" ontouchend="PararMovimento()">Esquerda</button>
    <button onmousedown="ComecarMovimento('Direita')" onmouseup="PararMovimento()" 
            ontouchstart="ComecarMovimento('Direita')" ontouchend="PararMovimento()">Direita</button>
